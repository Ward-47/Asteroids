...
const ROIDS_NUM = 3;  // starting number of asteroids at the beginning of the game
...
function drawShip(x,y,a, color = "green") {
    ...
    ctx.lineTo(
        x - ship.r * (2 / 3 * Math.cos(a) + Math.sin(a)), // try 4/3
        y + ship.r * (2 / 3 * Math.sin(a) - Math.cos(a)) // try 4/3
    );
...
function update() { 
    ...
    */
    ...
    ctx.fillText("High Score: " + scoreHigh, canv.width / 2, SHIP_SIZE); // high schore is displayed here
